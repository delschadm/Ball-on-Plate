#ifndef __Modell_PID_sfun_h__
#define __Modell_PID_sfun_h__
...
extern mxArray* load_Modell_PID_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_Modell_PID_optimization_info(void);
